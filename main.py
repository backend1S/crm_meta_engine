...
from crm import router, start_polling, import_all_leads
...
async def startup_event():
    ...
    # start facebook lead engine
    lead_thread = threading.Thread(target=run_lead_engine)
    lead_thread.daemon = True
    lead_thread.start()

    # start crm customer automation
    crm_thread = threading.Thread(target=run_customer_sync)
